  ...
  return (
    <div className='min-h-screen bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='mb-8  flex flex-wrap gap-6 '>
          {
            dataArray.map((item,index)=>(
              ...
              justify-center gap-1 border h-20 w-40 border-gray-200
        ...
        {/* Tabs- follower,following requests section  */}
        <div className='cursr-pointer inline-flex flex-wrap items-center border border-gray-200
              ...
              <button onClick={()=>setCurrentTab(tab.label)} key={tab.label} className={` cursor-pointer flex items-center px-3 py-1 text-sm 
                rounded-md transition-colors
                 ${currentTab===tab.label ? 'bg-white font-medium text-black':'text-gray-500 hover:text-black'}`}>
                   ...
                   {tab.count !== undefined && (<span className='ml-2 text-xs bg-gray-100 text-gray-700
