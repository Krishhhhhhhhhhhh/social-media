     ...
     lg:p1-40'>
      ...
      <div>
        <div className=' flex items-center gap-3 mb-4 max-md:mt-10'>
          <img src={assets.group_users} alt="" className='h-8 mid:h-10' />
          <div>
            <div className='flex'>
        ...
        <h1 className='text-3xl mid:text-6xl md:pb-2 font-bold bg-gradient-to-r
        ...
        <p className='text-x1 md:text-3xl text-indigo-900 max-w-72 md:max-w-md'>
          connect with global commuunity on pinupx
        </p>
      </div>
      <span className='mid:h-10'></span> 
