...
const UserCard = ({user}) => {
  ...
  return (
    <div key={user._id} className='p-4 pt-6 flex flex-col justify-between w-72 shadow border border-gray-700 rounded-md'>
        ...
        <div className='flex mt-4 gap-2'>
            {/* follow button  */}
              <button  onClick={handleFollow} className='w-full py-2 rounded-md flex justify-center items-center gap-2 
