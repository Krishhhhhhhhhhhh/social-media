  ...
  return (
    <div className='relative py-4 px-6 md:px-8 bg-white'>
        <div className='flex flex-col md:flex items-start gap-6'>
            ...
            rounded-full'>
                <img src={user.profile_picture} className='absolute rounded-full z-2' alt="" srcset="" />
            </div>
            <div className='w-full pt-16 md:pt-0 md:pl-36'>
                <div className='flex flex-col md:flex-row items-start justify-between'>
                  ...
                  {
                    !profileId && 
                    <button onClick={()=>setShowEdit(true)}className='flex items-center gap-2 border border-gray-300 hover:border-gray-50 
