...
const ProfileModel = ({ setShowEdit }) => {
    ...
    const handleSaveProfile = async (e) => {
        ...
        console.log('📝 Form data:', editForm); // DEBUG
        ...
        try {
            ...
            if (profile_picture) {
                ...
                console.log('✅ Profile picture attached'); // DEBUG
            }
            if (cover_photo) {
                userData.append('cover', cover_photo)
                console.log('✅ Cover photo attached'); // DEBUG
            }
            ...
            if (!token) {
                console.error('❌ No token received!'); // DEBUG
                toast.error('Authentication failed. Please log in again.');
                return;
            }
            
            console.log('✅ Token received:', token.substring(0, 20) + '...'); // DEBUG
            console.log('📤 Dispatching updateUser...'); // DEBUG
            ...
            if (result.payload) {
                ...
                console.error('❌ Update failed - no payload'); // DEBUG
            }

        } catch (error) {
            console.error('❌ Error in handleSaveProfile:', error); // DEBUG
                        ...
                        <div className='flex flex-col items-start gap-3'>
                            ...
                            font-medium text-gray-700 mb-1'>
                                ...
                                <input 
                                    ...
                                    onChange={(e) => {
                                        console.log('Profile picture selected:', e.target.files[0]); // DEBUG
                                        setEditForm({
                                            ...editForm,
                        ...
                        <div className='flex flex-col items-start gap-3'>
                            ...
                            text-gray-700 mb-1'>
                                ...
                                <input 
                                    ...
                                    className='w-full p-3 border border-gray-200 rounded-lg'
                                    onChange={(e) => {
                                        console.log('Cover photo selected:', e.target.files[0]); // DEBUG
                                        setEditForm({
                                            ...editForm,
